...
<body>
  ...
  <div class="container mt-5">
    <div class="row">
      ...
      <div class="col-md-6">
        <img src="IMAGE1.png" alt="Pharmaceutical Company" height="300" width="'400">
      </div>
    </div>
    <div class="row mt-5">
      <div class="col-md-4">
  ...
  <footer class="bg-dark text-light mt-5 py-3">
    <div class="container text-center">
      <p>&copy; 2024 Pharmaceutical Company. BY RUDESH KANNA R(212223233002).</p>
    </div>
  </footer>
...
<body>
  ...
  <div class="container mt-5">
    ...
    <div class="row">
      <div class="col-md-4">
        <div class="card mb-4">
          <img src="IMAGE2.png" class="card-img-top rounded-img" alt="Product Image">
          <div class="card-body">
      ...
      <div class="col-md-4">
        <div class="card mb-4">
          <img src="IMAGE3.png" class="card-img-top rounded-img" alt="Product Image">
          <div class="card-body">
      ...
      <div class="col-md-4">
        <div class="card mb-4">
          <img src="IMAGE4.png" class="card-img-top rounded-img" alt="Product Image">
          <div class="card-body">
...
```
## OUTPUT:
![image](https://github.com/user-attachments/assets/8a855410-6f7d-42d3-9313-7f646b84b95e)![image](https://github.com/user-attachments/assets/f1745f6d-46c8-42ed-ab6b-f1bb64e6994e)![image](https://github.com/user-attachments/assets/566c49d5-ecb9-4b54-91d9-5e434b706957)
